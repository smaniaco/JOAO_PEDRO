...
let gameType = prompt("Tipo de jogo (IN) internacional (DO) doméstico").toUpperCase()
let gamePhase = prompt("(SF) semi-final (DT) decisão de terceiro lugar (FL) final").toUpperCase()
const category = Number(prompt("Numero de 1 ao 4 para escolher a categoria (1 melhor e mais caro 4 pior e mais barato"))
